      ...
      <div className="p-4">
        ...
        <nav className="mb-4">
          <ul className="flex space-x-4">
            <li><Link href="/groupProject/aboutus" className="text-blue-500 hover:underline">About Us</Link></li>
            <li><Link href="/groupProject/contactus" className="text-blue-500 hover:underline">Contact Us</Link></li>
            <li><Link href="/groupProject/detail" className="text-blue-500 hover:underline">Detail</Link></li>
          </ul>
        </nav>
